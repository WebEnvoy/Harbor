...
3. Add directed real-shaped Vue DOM, forged/empty/unrelated node, late challenge, login/challenge overlay, never-responding page-list, client-abort, and public-boundary regressions.
...
- AC-006 -> automated: never-responding `/json/list` deadline and HTTP client-disconnect cancellation regressions.
