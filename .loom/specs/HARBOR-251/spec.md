...
- AC-005: only a mounted Vue app whose container, root component, app identity, and mounted subtree are bound to the canonical root containing a nonempty bounded set of structurally valid public job cards passes; shape-complete fake Vue objects, injected/empty/unrelated nodes, login, challenge, blank, unrendered, and unprobeable pages remain blocked, unavailable, or unknown without raw DOM/network/Cookie/token/profile output.
