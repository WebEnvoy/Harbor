...
| EV-002 | test_evidence | .loom/progress/HARBOR-219.md | pnpm typecheck, pnpm test, pnpm smoke:runtime, HTTP readiness/provider readback, git diff check, Loom verify/fact-chain | HARBOR-219 / local validation checks | present | review and PR readiness only | Rerun validation and update progress after code, carrier, or PR metadata edits. |
