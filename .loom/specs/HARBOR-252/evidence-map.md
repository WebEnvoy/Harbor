...
| EV-002 | test_evidence | local verification | typecheck, 38-test targeted suite, and 70-test full suite | current working tree | present | implementation only, not live E2E | Rerun after every code change. |
