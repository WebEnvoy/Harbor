...
- XHS completion requires Vue hydration, a note-like Pinia store, exact target document response, rendered detail fields, public note ID/author/metrics/citation, and declared refs. BOSS exposes only the opaque `detail_ref`, bounded job/company/recruiter/citation fields, and declared refs; raw security identifiers remain internal.
